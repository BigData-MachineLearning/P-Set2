...
lasso_recipe <- 
  recipe(formula = price ~ year + surface_total +estrato_closest + bedrooms + bathrooms + property_type2 + parqueadero  + pent_house + distancia_bus + ciclovia_near + distancia_parque + distancia_cc 
         , data = train) %>%
