...
forest_recipe <- 
  ...
  step_interact(terms = ~ bathrooms:bedrooms + distancia_bus:ciclovia_near+distancia_bus:estrato+distancia_parque:estrato+distancia_cc:estrato) %>% 
...
rio::export(submission_forest_2, "results/tanda2_forest4.csv")
