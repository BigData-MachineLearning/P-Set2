...
submission_boost_3 <- test |> select(property_id, pred1) |>
  rename(price = pred1) |>
  mutate(price = round(price))


rio::export(submission_boost_3, "results/tanda2_boost3.csv")
...
submission_boost_2 <- test |> select(property_id, pred1) |>
  rename(price = pred1) |>
  mutate(price = round(price))


rio::export(submission_boost_2, "results/tanda2_boost2.csv")
...
rio::export(submission_boost_1, "results/tanda2_boost1.csv")
